      ...
      <SectionHeader 
        ...
        rightElement={
          <div className="flex gap-2">
            <Button className="rounded-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold h-10 px-6 shadow-lg shadow-indigo-600/20 active:scale-95 transition-all">
