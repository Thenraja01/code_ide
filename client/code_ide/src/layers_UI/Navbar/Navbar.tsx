...
export default function Navbar() {
    ...
    return (
        <>
            <div className="flex md:grid items-center py-4 px-2   justify-between md:justify-normal border-b-neutral-300">
                <div className=" md:flex items-center justify-between space-x-3">
                    ...
                    <div className="hidden md:flex space-x-3 place-items-center-safe">
                        <div className="gap-3 flex">
                            ...
                            <Button variant={"ghost"} className="bg-chart-2 text-sm" onClick={()=>navigate('/login')}>login</Button>
                            <Button variant={"ghost"} className="bg-blue-600" onClick={()=>navigate('/login')}>Sign Up</Button>
                        </div>
